...
# Function to draw the layout and selected shape
def draw_layout_and_shape(modules, shape_properties, selected_shape):
...
# Draw and display the layout and shape
fig = draw_layout_and_shape(modules, shape_properties, selected_shape)
st.pyplot(fig)
