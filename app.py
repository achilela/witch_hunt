...
layout += '''
    ...
    <div style='display: flex; justify-content: flex-end; width: 100%; margin-top: -150px;'>
        <div style='border: 2px solid black; border-radius: 10px; background-color: white; padding: 20px; text-align: center; width: 20%; margin-right: 40px;'>M131 Flare</div>
    </div>
</div>
'''
